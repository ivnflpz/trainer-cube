  ...
  const renderColorPicker = (
    ...
    <div>
      ...
      <ColorPicker
        value={colors[face]}
        onChange={(color) =>
          updateColors(face, color.css.backgroundColor || colors[face])
        }
      />
    </div>
  );
    ...
    <section className={classes.cubeContainer}>
      ...
      <div>
        <div className={clsx(classes.colorRow, classes.colorRowOffset)}>
          <span className={classes.colorButton}>
            <ColorButton color={colors.B} />
          </span>
        </div>
        <div className={classes.colorRow}>
          <span className={classes.colorButton}>
            <ColorButton color={colors.L} />
          </span>
          <span className={classes.colorButton}>
            <ColorButton color={colors.D} />
          </span>
          <span className={classes.colorButton}>
            <ColorButton color={colors.R} />
          </span>
          <span className={classes.colorButton}>
            <ColorButton color={colors.U} />
          </span>
        </div>
        <div className={clsx(classes.colorRow, classes.colorRowOffset)}>
          <span className={classes.colorButton}>
            <ColorButton color={colors.F} />
          </span>
        </div>
      </div>
    </section>
    ...
    <>
      <Card variant="outlined">
        ...
        <CardActions className={classes.cardActions}>
          ...
          >
            <Typography>
              Are you sure you want to reset to the default scheme?
            </Typography>
          </AlertDialog>
        </CardActions>
      </Card>
